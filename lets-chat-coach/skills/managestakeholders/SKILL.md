...
2. If `start_session` reports that this product isn't available on the account (access-denied / "use case not available", or it lists other products but not this one), do NOT improvise or coach freehand. Tell the user "Manage My Stakeholders isn't active on your account yet," list what `start_session` says they DO have, offer one of those, and stop.
